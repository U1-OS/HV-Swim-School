...
def main():
    ...
    expect("health endpoint", status == 200 and health.get("version") == "5.5.0")
    ...
    expect("native mobile launch shell", "Open connected app" in mobile_shell and "V5.5" in mobile_shell)

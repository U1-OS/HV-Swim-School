...
def main():
    ...
    expect("health endpoint", status == 200 and health.get("version") == "5.3.0")
    ...
    expect("native mobile launch shell", "Open connected app" in mobile_shell and "V5.3" in mobile_shell)

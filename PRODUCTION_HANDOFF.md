...
- Confirm enrolment authority, waitlist priority rules, payment collection and signed-terms requirements before managers confirm real families into classes. The public website and family portal are enquiry-only: self-service booking and self-service waitlist joining are deliberately blocked by both the interface and role permissions.

const CORE_CACHE = 'hv-swim-v590-core-1';
const RUNTIME_CACHE = 'hv-swim-v590-runtime-1';
const PUBLIC_DATA_CACHE = 'hv-swim-v590-public-data-1';
const CORE_SHELL = [
  './offline.html', './manifest.webmanifest',
  './assets/styles.css?v=5.9.0', './assets/app.js?v=5.9.0',
  './assets/support.css?v=5.9.0', './assets/support.js?v=5.9.0',

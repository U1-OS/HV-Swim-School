const CACHE = 'hv-swim-v5-shell-16';
...
const SHELL = [
  ...
  './assets/styles.css?v=5.1.0', './assets/app.js?v=5.1.0', './assets/hv-swim-logo.png', './assets/hero-swimmer.jpg', './assets/merch-collection-v2.jpg', './assets/merch-uniform-studio-v3.jpg',

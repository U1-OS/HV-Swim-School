const CACHE = 'hv-swim-v5-shell-21';
...
const SHELL = [
  ...
  './assets/platform.css?v=5.1.1', './assets/platform.js?v=5.1.1', './assets/public-api.js?v=5.1.1', './assets/programs.js?v=5.1.1', './assets/shop.js?v=5.1.1', './assets/enquire.js?v=5.1.1', './assets/mobile-shell.css?v=5.1.0', './assets/mobile-shell.js?v=5.1.0',

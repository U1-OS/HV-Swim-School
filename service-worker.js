const CORE_CACHE = 'hv-swim-v5130-core-33';
const RUNTIME_CACHE = 'hv-swim-v5130-runtime-33';
const PUBLIC_DATA_CACHE = 'hv-swim-v5130-public-data-33';
const PRIVATE_NAV = /\/(?:login|platform|admin|staff|customer|START_HERE)\.html$/i;
const CORE_SHELL = [
  './assets/experience.css?v=5.13.0-ui31', './assets/experience.js?v=5.13.0-ui31',
  './assets/public.css?v=5.13.0-ui31',
  './offline.html', './manifest.webmanifest',
  './assets/styles.css?v=5.13.0-ui31', './assets/app.js?v=5.13.0-ui31',
  './assets/support.css?v=5.13.0-ui31', './assets/support.js?v=5.13.0-ui31',

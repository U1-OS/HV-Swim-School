# HV Swim Bendigo mobile app · paused after V5.11.0
...
> separately scoped mobile phase can resume without rebuilding its foundation.
...
- Staff clock-on/off, break recording, reviewed timesheets and pool readings without GPS or continuous location tracking
- Staff ticket triage plus management alerts for closures, changes and reopenings
- Management enrolment desk, approvals, website controls and 24-product merchandise workflow
...
- Configure production email/SMS/Web Push/APNs/FCM providers and notification consent. V5.11.0 browser alerts update while the site is open; background native delivery is not claimed yet.

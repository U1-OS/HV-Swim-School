# HV Swim Bendigo mobile app · V5.8.0
...
- Configure production email/SMS/Web Push/APNs/FCM providers and notification consent. V5.8.0 browser alerts update while the site is open; background native delivery is not claimed yet.

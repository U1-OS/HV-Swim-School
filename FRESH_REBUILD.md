...
### Final narrow-screen correction

The preview account icons generated by platform.js initially inherited the browser’s
300px SVG default in the new sign-in layout. Explicit shared icon dimensions fix the
resulting horizontal overflow. Verified actual 320px layouts on the selected browser tab
for sign-in, home, programs, venues, enquiry, collection and child safety. Mobile menu and
Escape behavior pass. Site stylesheet revision Fresh 2 and worker revision 29 invalidate
the old rendering. Temporary viewport overrides were reset.

GitHub checkpoint `57699b8` passed all three jobs and dependency audits in run
[34703854753](https://github.com/U1-OS/HV-Swim-School/actions/runs/34703854753).
